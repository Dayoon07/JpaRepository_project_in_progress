	...
	<div class="mx-auto max-w-md w-full bg-white border border-gray-300 p-8 rounded-lg shadow-md" style="margin-top: 100px;">
        ...
        <form action="${ cl }/create/createChatRoom" method="post" autocomplete="off">
            <div class="mb-4">
                ...
                <input class="mt-1 block w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" id="roomname" name="roomname" placeholder="채팅 방 이름을 입력하세요" required>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700" for="roomnameinname">채팅 방 설명</label>
                <textarea class="mt-1 block w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" id="roomnameinname" name="roomnameinname" placeholder="채팅 방 설명을 입력하세요" style="resize: none;" rows="4" required></textarea>
            </div>
            <div class="mb-4">
            	<label class="block text-gray-700" for=""></label>
            </div>
